...
# define DL_LOADADDR_TYPE Elf32(Addr)
#endif
...
#define DL_BOOT_COMPUTE_DYN(DPNT, GOT, LOAD_ADDR) \
    ((DPNT) = ((Elf32(Dyn) *) DL_RELOC_ADDR(LOAD_ADDR, GOT)))
#endif
...
# define DL_FIND_HASH_VALUE(TPNT, TYPE, SYM) (DL_RELOC_ADDR ((((TPNT)->mapaddr == (TPNT)->loadaddr) ? (TPNT)->loadaddr : 0) \
            , (SYM)->st_value))
#endif
